const { h2, body, emptyLine, imgPlaceholder, figCaption, codeLine, pageBreak } = require('../utils');
...
module.exports = function getChapter6_3() {
  return [
    ...
    emptyLine(),
    imgPlaceholder("Figure 6.3: Apollo Client SSE State Reconciliation Sequence"),
