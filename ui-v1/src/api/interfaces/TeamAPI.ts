...
export interface TeamAPI {
  getTeams(projectId: string, pagination?: PaginationArgs & { search?: string }): Promise<{ teams: Team[], pageInfo: PageInfo }>;
  getTeam(teamId: string): Promise<Team | null>;
  getTeamDetail(teamId: string): Promise<{
    team: Team | null,
    members: { members: TeamMember[], pageInfo: PageInfo },
  }>;
  getTeamMembers(projectId: string, teamId: string, pagination?: PaginationArgs & { search?: string }): Promise<{ members: TeamMember[], pageInfo: PageInfo }>;
  createTeam(projectId: string, name: string): Promise<{ success: boolean; team?: Team }>;
  updateTeam(projectId: string, teamId: string, name: string, version: number): Promise<{ success: boolean; team?: Team }>;
